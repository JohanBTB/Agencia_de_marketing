...
import palette from "assets/img/icons/palette.PNG"
...
const navigation = {
    ...
    callus: [
      { name: 'USA: +1 (999) 555444', href: '#' },
      { name: 'Chile: +56 (12) 123456789', href: '#' },
      { name: 'Peru +51 (45) 654987312', href: '#' },
      { name: 'Ecuador +593 (444) 321654978', href: '#' },
    ],
    services: [
      { name: 'Auditory', href: '#' },
      { name: 'TI Engineering', href: '#' },
      { name: 'Machine Learning', href: '#' },
      { name: 'Net Security', href: '#' },
      { name: 'Web Designment', href: '#' },
    ],
    company: [
