...
function Header(){
    ...
    return (
        <section class=" sm:pt-32 sm:pb-64 h-screen   bg-white dark:bg-gray-900 sm:flex-nowrap my-48 sm:my-0">
            
            <div class="w-4/5  flex align-center jusitfy-center mx-auto text-myblue-300 dark:text-mylightblue-100"  >
                
                <div class=" mt-10 mr-auto tracking-tight  z-10">
            ...
            <img src={main} class="absolute mt-36 top-0 right-0 opacity-25 absolute min-h-screen sm:min-h-[50%] sm:opacity-50 overflow-x-hidden" />
        </section>
